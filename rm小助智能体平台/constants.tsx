import { AgentConfig, FileItem, ChatMessage, DataField, Skill, EnvConfig, MockCustomer, AgentSummary, AssociatedItem } from './types';
...
export const MOCK_ASSOCIATED_ITEMS: AssociatedItem[] = [
  { id: '120267237', name: '金葵花ETF大赛数据库0909', type: 'project' },
  { 
    id: 'B_AOWY', 
    name: '代发客户类型', 
    type: 'tag',
    valueType: 'category',
    values: ['标准代发', '非标准代发', '无代发'],
    isConfiguredInInsight: true
  },
  { 
    id: 'AUM_AMT', 
  ...
  { id: 'OPP_001', name: '理财到期商机', type: 'opportunity' },
  { id: 'PROJ_002', name: '养老金开户专案', type: 'project' },
  { 
    id: 'TAG_VIP', 
    name: '私行潜力客户', 
    type: 'tag',
